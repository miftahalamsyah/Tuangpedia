    ...
    <div class="media-body">
        ...
        <div>
            ...
            @can('delete-comment', $comment)
                <a href="{{ route('comments.destroy', $comment->getKey()) }}" onclick="event.preventDefault();document.getElementById('comment-delete-form-{{ $comment->getKey() }}').submit();" class="fs-6 text-danger text-uppercase"style="width:3rem">@lang('comments::comments.delete')</a>
