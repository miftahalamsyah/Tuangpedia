...
<?php if($comments->count() < 1): ?>
    <div class="alert alert-warning"><?php echo app('translator')->get('tidak ada komentar'); ?></div>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Applications\coba-laravel\resources\views/vendor/comments/components/comments.blade.php ENDPATH**/ ?>