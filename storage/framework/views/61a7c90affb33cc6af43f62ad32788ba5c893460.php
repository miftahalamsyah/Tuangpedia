        ...
        <form method="POST" action="<?php echo e(route('comments.store')); ?>">
            ...
            <?php if(isset($guest_commenting) and $guest_commenting == true): ?>
                <div class="form-group">
                    <label for="message"><?php echo app('translator')->get('Masukan Nama'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label for="message"><?php echo app('translator')->get('Masukan Email'); ?></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label for="message"><?php echo app('translator')->get('Masukan Komentar Anda'); ?></label>
                <textarea class="form-control mt-2 <?php if($errors->has('message')): ?> is-invalid <?php endif; ?>" name="message" rows="3"></textarea>
                <div class="invalid-feedback">
                    <?php echo app('translator')->get('Komentar Perlu Diisi'); ?>
                </div>
            </div>
            <button type="submit" class="btn btn-sm btn-tp  text-uppercase mt-2"><?php echo app('translator')->get('comments::comments.submit'); ?></button>
        </form>
    </div>
</div>
<br /><?php /**PATH D:\Applications\coba-laravel\resources\views/vendor/comments/_form.blade.php ENDPATH**/ ?>